<?php
namespace User\NewsBundle\DataFixtures\ORM;

use Doctrine\Common\DataFixtures\AbstractFixture;
use Doctrine\Common\DataFixtures\OrderedFixtureInterface;
use Doctrine\Common\Persistence\ObjectManager;
use User\NewsBundle\Entity\Blog;
...
class BlogFixtures implements FixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $blog1->setImage('11.jpg');
        $blog1->setAuthor('Mfds');
        $blog1->setTags('php, paradise, newsblog');
        ...
        $blog2->setImage('12.jpg');
        $blog2->setAuthor('Zero Cool');
        $blog2->setTags('pool, leaky, hacked, movie, hacking, newsblog');
        ...
        $blog3->setImage('13.jpg');
        $blog3->setAuthor('Gabriel');
        $blog3->setTags('misdirection, magic, movie, hacking, newsblog');
        ...
        $blog4->setImage('14.jpg');
        $blog4->setAuthor('Kevin Flynn');
        $blog4->setTags('grid, daftpunk, movie, newsblog');
        ...
        $blog5->setImage('15.jpg');
        $blog5->setAuthor('Gary Winston');
        $blog5->setTags('binary, one, zero, alive, dead, !trusting, movie, newsblog');
